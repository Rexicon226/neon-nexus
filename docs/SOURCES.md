# Sources (Where we found information and dark arts)

## Zig

- [dos.zig](https://github.com/jayschwa/dos.zig)

## DPMI

- [DPMI Specification](http://www.delorie.com/djgpp/doc/dpmi/)
- [Mailing List From 1996 (DPMI and Graphics)](https://groups.google.com/g/comp.os.msdos.djgpp/c/seMyp8I4GHI)
    - This was used for mapping VGA video memory to a linear address space

## Graphics

- [List of Graphics Modes](https://www.fountainware.com/EXPL/video_modes.htm)
