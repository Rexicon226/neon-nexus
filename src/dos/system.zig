...
pub const FarPtr = @import("far_ptr.zig").FarPtr;
...
pub fn int(interrupt: u8, registers: dpmi.RealModeRegisters) dpmi.RealModeRegisters {
    var regs = registers;
    dpmi.simulateInterrupt(interrupt, &regs);
